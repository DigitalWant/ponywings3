...
pony.draw = function() {
    ...
    if (HUD.timer > 0) {
        if (pony.touchGround2) {
            if (pony.keyDown) {
                ctx.drawImage(pony.image, 202, Math.floor(pony.frame) * 200 + 2, 196, 196, -200 / 2, -200 + 20, 200, 200);
            } else {
                ctx.drawImage(pony.image, 2, Math.floor(pony.frame) * 200 + 2, 196, 196, -200 / 2, -200 + 20, 200, 200);
            }
        } else {
            if (HUD.timer > 0 && pony.keyDown) {
                ctx.drawImage(pony.image, 602, Math.floor(pony.frame) * 200 + 2, 196, 196, -200 / 2, -200 + 20, 200, 200);
            } else {
                ctx.drawImage(pony.image, 402, Math.floor(pony.frame) * 200 + 2, 196, 196, -200 / 2, -200 + 20, 200, 200);
            }
        }
    } else {
        ...
        if (pony.touchGround3) {
            ctx.drawImage(pony.image, 800, Math.floor(pony.frame) * 200, 200, 200, -200 / 2, -200 + 20, 200, 200);
        } else {
            ctx.drawImage(pony.image, 400, Math.floor(pony.frame) * 200, 200, 200, -200 / 2, -200 + 20, 200, 200);
        }
    }
    // RESTORE
    ctx.restore();
